...
public abstract class MessageServiceCallbackHandler {
     ...
     */
    public void receiveErrorgetAllMessage(Exception e) {
    }
     ...
     */
    public void receiveErrorcreateMessage(Exception e) {
    }
     ...
     */
    public void receiveErrordeleteMessage(Exception e) {
    }
    ...
    public void receiveResultgetMessageFrom(
        MessageServiceStub.GetMessageFromResponse result) {
    }
     ...
     */
    public void receiveErrorgetMessageFrom(Exception e) {
    }
    ...
    public void receiveResultgetMyMessage(
        MessageServiceStub.GetMyMessageResponse result) {
    }
     ...
     */
    public void receiveErrorgetMyMessage(Exception e) {
    }
}
